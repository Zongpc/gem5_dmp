...
for r in "${r_values[@]}"; do
    ...
    --l2_repl_policy LRURP --l1d-hwp-type DiffMatchingPrefetcher --dmp-notify l1 \
    ...
    --script=mount_target/mchashjoins.rcS --checkpoint-dir=/home/luoqiang/xymc/gem5_dda/m5out/tlb_65536_change -r $r \
    --restore-with-cpu=O3_ARM_v7a_3
"

    # 执行第一个指令
    echo "执行指令: $first_command"
    eval $first_command | grep "Insert RelationTable:"> ${r}.txt
